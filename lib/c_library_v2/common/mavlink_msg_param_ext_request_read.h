...
{
    int16_t
        param_index; /*<  Parameter index. Set to -1 to use the Parameter ID field as identifier (else param_id will be ignored)*/
    uint8_t target_system;    /*<  System ID*/
    uint8_t target_component; /*<  Component ID*/
    char param_id
        [16]; /*<  Parameter id, terminated by NULL if the length is less than 16 human-readable chars and WITHOUT null termination (NULL) byte if the length is exactly 16 chars - applications have to provide 16+1 bytes storage if the ID is stored as string*/
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            {"target_system",                                                                                          \
             ...
             0,                                                                                                        \
             2,                                                                                                        \
             offsetof(mavlink_param_ext_request_read_t, target_system)},                                               \
                {"target_component",                                                                                   \
                 NULL,                                                                                                 \
                 MAVLINK_TYPE_UINT8_T,                                                                                 \
                 0,                                                                                                    \
                 3,                                                                                                    \
                 offsetof(mavlink_param_ext_request_read_t, target_component)},                                        \
                ...
                {"param_index",                                                                                        \
                 ...
                 0,                                                                                                    \
                 0,                                                                                                    \
                 offsetof(mavlink_param_ext_request_read_t, param_index)},                                             \
        }                                                                                                              \
    }
#else
#define MAVLINK_MESSAGE_INFO_PARAM_EXT_REQUEST_READ                                                                    \
    {                                                                                                                  \
        "PARAM_EXT_REQUEST_READ", 4,                                                                                   \
        {                                                                                                              \
            {"target_system",                                                                                          \
             NULL,                                                                                                     \
             MAVLINK_TYPE_UINT8_T,                                                                                     \
 ...
 */
static inline uint16_t mavlink_msg_param_ext_request_read_pack(uint8_t system_id,
                                                               ...
                                                               int16_t param_index)
{
    ...
    return mavlink_finalize_message(msg,
                                    system_id,
                                    component_id,
                                    MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_MIN_LEN,
                                    MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_LEN,
                                    MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_param_ext_request_read_pack_status(uint8_t system_id,
                                                                      uint8_t component_id,
                                                                      ...
                                                                      int16_t param_index)
{
    ...
    return mavlink_finalize_message_buffer(msg,
                                           system_id,
                                           component_id,
                                           _status,
                                           MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_MIN_LEN,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_param_ext_request_read_pack_chan(uint8_t system_id,
                                                                    uint8_t component_id,
                                                                    uint8_t chan,
                                                                    mavlink_message_t *msg,
                                                                    uint8_t target_system,
                                                                    ...
                                                                    int16_t param_index)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ;
    return mavlink_finalize_message_chan(msg,
                                         system_id,
                                         component_id,
                                         chan,
                                         MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_MIN_LEN,
 ...
 */
static inline uint16_t mavlink_msg_param_ext_request_read_encode(
    uint8_t system_id,
    uint8_t component_id,
    mavlink_message_t *msg,
    const mavlink_param_ext_request_read_t *param_ext_request_read)
{
    return mavlink_msg_param_ext_request_read_pack(system_id,
                                                   component_id,
                                                   msg,
                                                   param_ext_request_read->target_system,
                                                   param_ext_request_read->target_component,
                                                   param_ext_request_read->param_id,
                                                   param_ext_request_read->param_index);
}
 ...
 * @param param_ext_request_read C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_param_ext_request_read_encode_chan(
    uint8_t system_id,
    uint8_t component_id,
    uint8_t chan,
    mavlink_message_t *msg,
    const mavlink_param_ext_request_read_t *param_ext_request_read)
{
    return mavlink_msg_param_ext_request_read_pack_chan(system_id,
                                                        component_id,
                                                        chan,
                                                        msg,
                                                        param_ext_request_read->target_system,
 ...
 * @param param_ext_request_read C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_param_ext_request_read_encode_status(
    uint8_t system_id,
    uint8_t component_id,
    mavlink_status_t *_status,
    mavlink_message_t *msg,
    const mavlink_param_ext_request_read_t *param_ext_request_read)
{
    return mavlink_msg_param_ext_request_read_pack_status(system_id,
                                                          component_id,
                                                          _status,
                                                          msg,
                                                          param_ext_request_read->target_system,
...
static inline void mavlink_msg_param_ext_request_read_send(mavlink_channel_t chan,
                                                           uint8_t target_system,
                                                           uint8_t target_component,
                                                           const char *param_id,
                                                           int16_t param_index)
 ...
 */
static inline void mavlink_msg_param_ext_request_read_send_struct(
    mavlink_channel_t chan,
    const mavlink_param_ext_request_read_t *param_ext_request_read)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_ext_request_read_send(chan,
                                            param_ext_request_read->target_system,
                                            param_ext_request_read->target_component,
                                            param_ext_request_read->param_id,
                                            param_ext_request_read->param_index);
    ...
    _mav_finalize_message_chan_send(chan,
                                    MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ,
                                    (const char *)param_ext_request_read,
                                    MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_MIN_LEN,
                                    MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_LEN,
                                    MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_CRC);
#endif
 ...
 */
static inline void mavlink_msg_param_ext_request_read_send_buf(mavlink_message_t *msgbuf,
                                                               mavlink_channel_t chan,
                                                               uint8_t target_system,
                                                               uint8_t target_component,
                                                               const char *param_id,
 ...
 */
static inline void mavlink_msg_param_ext_request_read_decode(const mavlink_message_t *msg,
...
#else
    uint8_t len =
        msg->len < MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_LEN ? msg->len : MAVLINK_MSG_ID_PARAM_EXT_REQUEST_READ_LEN;
