        ...
        {                                                                                                              \
            {"target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_param_ext_set_t, target_system)},     \
                {"target_component",                                                                                   \
                 ...
                 0,                                                                                                    \
                 1,                                                                                                    \
                 offsetof(mavlink_param_ext_set_t, target_component)},                                                 \
 ...
 */
static inline uint16_t mavlink_msg_param_ext_set_pack(uint8_t system_id,
                                                      ...
                                                      uint8_t param_type)
{
    ...
    return mavlink_finalize_message(msg,
                                    ...
                                    MAVLINK_MSG_ID_PARAM_EXT_SET_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_param_ext_set_pack_status(uint8_t system_id,
                                                             uint8_t component_id,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_param_ext_set_pack_chan(uint8_t system_id,
                                                           uint8_t component_id,
                                                           uint8_t chan,
                                                           mavlink_message_t *msg,
                                                           uint8_t target_system,
 ...
 */
static inline uint16_t mavlink_msg_param_ext_set_encode(uint8_t system_id,
                                                        uint8_t component_id,
                                                        mavlink_message_t *msg,
                                                        const mavlink_param_ext_set_t *param_ext_set)
{
    return mavlink_msg_param_ext_set_pack(system_id,
                                          component_id,
                                          msg,
                                          param_ext_set->target_system,
                                          param_ext_set->target_component,
                                          param_ext_set->param_id,
 ...
 * @param param_ext_set C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_param_ext_set_encode_chan(uint8_t system_id,
                                                             uint8_t component_id,
                                                             uint8_t chan,
                                                             mavlink_message_t *msg,
                                                             const mavlink_param_ext_set_t *param_ext_set)
{
    return mavlink_msg_param_ext_set_pack_chan(system_id,
                                               component_id,
                                               chan,
                                               msg,
                                               param_ext_set->target_system,
 ...
 * @param param_ext_set C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_param_ext_set_encode_status(uint8_t system_id,
                                                               uint8_t component_id,
                                                               mavlink_status_t *_status,
                                                               mavlink_message_t *msg,
                                                               const mavlink_param_ext_set_t *param_ext_set)
{
    return mavlink_msg_param_ext_set_pack_status(system_id,
                                                 component_id,
                                                 _status,
                                                 msg,
                                                 param_ext_set->target_system,
...
static inline void mavlink_msg_param_ext_set_send(mavlink_channel_t chan,
                                                  uint8_t target_system,
                                                  uint8_t target_component,
                                                  const char *param_id,
                                                  const char *param_value,
 ...
 */
static inline void mavlink_msg_param_ext_set_send_struct(mavlink_channel_t chan,
                                                         const mavlink_param_ext_set_t *param_ext_set)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_param_ext_set_send(chan,
                                   param_ext_set->target_system,
                                   param_ext_set->target_component,
                                   param_ext_set->param_id,
                                   param_ext_set->param_value,
 ...
 */
static inline void mavlink_msg_param_ext_set_send_buf(mavlink_message_t *msgbuf,
 ...
 */
static inline void mavlink_msg_param_ext_set_decode(const mavlink_message_t *msg,
